...
NonIntegerArrayIndexError::NonIntegerArrayIndexError(Location p_location)
    : Error{p_location} {}
...
IncompatibleArgumentTypeError::IncompatibleArgumentTypeError(
    Location p_location, const PType *p_expected, std::string p_actual)
    : Error{p_location},
...
std::string IncompatibleArgumentTypeError::getMessage() const {
  return "incompatible type passing '" +
         std::string{m_expected->getPTypeCString()} + "' to parameter of type '" +
         std::string{m_actual} + "'";
}

ReadToNonScalarTypeError::ReadToNonScalarTypeError(
    Location p_location)
    : Error{p_location} {}
...
ReadToConstantOrLoopVarError::ReadToConstantOrLoopVarError(
    Location p_location)
    : Error{p_location} {}
...
PrintOutNonScalarTypeError::PrintOutNonScalarTypeError(
    Location p_location)
    : Error{p_location} {}
...
AssignWithArrayTypeError::AssignWithArrayTypeError(
    Location p_location)
    : Error{p_location} {}
...
AssignToLoopVarError::AssignToLoopVarError(
    Location p_location)
    : Error{p_location} {}
...
NonBooleanConditionError::NonBooleanConditionError(
    Location p_location)
    : Error{p_location} {}
...
NonIncrementalLoopVariableError::NonIncrementalLoopVariableError(
    Location p_location)
    : Error{p_location} {}
...
ReturnFromVoidError::ReturnFromVoidError(
    Location p_location)
    : Error{p_location} {}
