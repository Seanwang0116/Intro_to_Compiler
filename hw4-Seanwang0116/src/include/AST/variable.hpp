...
class VariableNode final : public AstNode {
  private:
    ...
    bool parameter_or_not = false;
    bool loop_var_or_not = false;
  ...
  public:
    ...
    const char* getAttribute() const { return m_constant_value_node_ptr ? m_constant_value_node_ptr->getConstantValueCString() : ""; }
    
    void set_parameter(bool set);
    void set_loop_var(bool set);
